...
namespace GameMain
{
    public class ProcedureChangeScene : GameFramework.Procedure.ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            GameEntry.Scene.LoadScene(sceneName, GameMain.Constant.AssetPriority.SceneAsset, this);
        }
        ...
        private void OnLoadSceneSuccess(object sender, GameEventArgs e)
        {
            ...
            if (camera)
            {
                ...
                universalAdditionalCameraData.cameraStack.Add(GameEntry.UI.UICamera);
            }
        }
