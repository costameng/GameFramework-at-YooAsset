...
namespace GameProto.proto
{
  ...
  public partial class role_prop_player_s2c : global::ProtoBuf.IExtensible
  {
    ...
    private readonly global::System.Collections.Generic.List<p_kv_int> _kv_list = new global::System.Collections.Generic.List<p_kv_int>();
    [global::ProtoBuf.ProtoMember(1, Name=@"kv_list", DataFormat = global::ProtoBuf.DataFormat.Default)]
    public global::System.Collections.Generic.List<p_kv_int> kv_list
    {
      get { return _kv_list; }
    }
